---
name: norse-about
description: About Norse project. Background, motivation, acknowledgments, and contact information.
allowed-tools: Bash
---
...
This includes computation speed, energy efficiency, solving the von Neumann bottleneck, and the large host of applications that follow these properties.
...
The research has received funding from the EC Horizon 2020 Framework Programme under Grant Agreements 785907 and 945539 (HBP) and by the Deutsche Forschungsgemeinschaft (DFG, German Research Foundation) under Germany's Excellence Strategy EXC 2181/1 - 390900948 (the Heidelberg STRUCTURES Excellence Cluster).
...
- [Benchmark Results](norse/benchmark/README.md)

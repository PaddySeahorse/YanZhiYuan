---
name: norse-benchmark
description: Norse benchmark results. Performance comparisons with BindsNET and GeNN for LIF neurons.
allowed-tools: Bash
---
...
On a longer timescale, we hope to document the improved quality and speed of Norse by comparing future performance with past releases.
...
The graph below shows a benchmark between Norse, BindsNET, and GeNN simulating poisson encoded input to a linearly weighted layer of LIF neurons. The simulation ran on a AMD Ryzen Threadripper 3960X 24-Core machine with a NVIDIA RTX 3090 24 GB RAM GPU for 1000 
...
![LIF Benchmark](norse/benchmark/lif_benchmark.png)
...
![Norse LIF Benchmark](norse/benchmark/norse_lif_benchmark.png)

## Benchmark Files

- [norse/benchmark/lif_benchmark.png](norse/benchmark/lif_benchmark.png)
- [norse/benchmark/norse_lif_benchmark.png](norse/benchmark/norse_lif_benchmark.png)
- [norse/benchmark/main.py](norse/benchmark/main.py)
- [norse/benchmark/norse_lif.py](norse/benchmark/norse_lif.py)
- [norse/benchmark/genn_lif.py](norse/benchmark/genn_lif.py)
- [norse/benchmark/bindsnet_lif.py](norse/benchmark/bindsnet_lif.py)

## Related Documentation

- [Main README](README.md)
- [Hardware Acceleration](docs/pages/hardware.rst)
- [Tasks](docs/pages/tasks.rst)

---
name: norse-contributing
description: Contributing guidelines for Norse project. How to submit bugs, contribute code, and get in touch with maintainers.
allowed-tools: Bash
---
...
- [API Documentation](docs/norse.torch.rst)

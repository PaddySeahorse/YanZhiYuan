---
name: norse-tasks
description: Norse built-in tasks and examples. MNIST, CIFAR10, cartpole, memory tasks and more.
allowed-tools: Bash
---
...
The memory task demonstrates how a recurrent spiking neural network can store a pattern and later recall it, similar to the STORE/RECALL experiment in the paper on Biologically inspired alternatives to backpropagation through time for learning in recurrent neural nets.
